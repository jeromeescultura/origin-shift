      ...
      <div className=" w-[90%] lg:w-[95%] xl:w-[80%] mx-auto pb-24 space-y-16 lg:space-y-32">
        ...
        <div className="flex justify-center flex-grow rounded-lg w-full ">
          ...
          <div className="absolute pt-16 lg:pt-28 text-center lg:text-left sm:w-[80%] md:w-[90%] lg:w-[75%] xl:w-[65%]">
            <h2 className="text-4xl lg:text-[56px] lg:leading-snug  text-primaryText font-bold sm:px-10 lg:px-0 lg:w-[500px]">
              Business energy that's affordable <br />
              &amp; future proof
            </h2>
            <p className="text-secondaryText mt-8 font-light sm:px-4 lg:px-0 lg:w-[60%]">
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-10 lg:mt-16 items-center sm:flex-row justify-center lg:justify-start">
              <ButtonComponent
                text="Start assessment"
                action={handleAssessmentBtn}
              />
              <button className="w-[220px] text-secondaryBG border-secondaryBG border rounded-full py-3 px-8">
                Lets have a chat
              </button>
            </div>
          </div>
        ...
        <div className="text-center font-light sm:w-[80%] lg:w-[80%] xl:w-[75%] mx-auto">
          <h2 className="">
            Australia's 2.4 million small-medium enterprises are responsible for
            over 1 quarter of the nation's carbon emissions annually.
          </h2>
        ...
        <div className="flex flex-col lg:flex-row lg:gap-32 sm:w-[80%] md:w-full lg:w-[90%] xl:w-[75%] mx-auto">
          <div className="text-center lg:text-left">
            <h2 className="text-primaryText font-bold">
              Three simple steps to cleaner, and cost-effective energy solutions
            </h2>
          ...
          <div className="flex flex-col gap-12 mt-8 lg:mt-0">
            ...
            <div className="flex gap-6 ">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="font-light">
                  Instantly we'll recommend the steps your business can take to
                  transition to cleaner energy solutions, at a price point that
                  suits you.
                </p>
              </div>
            </div>
            <div className="flex gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="font-light">
                  Understand the impact your business is making, and how you can
                  further reduce it's carbon footprint with Origin.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="sm:w-[80%] md:w-full lg:w-[80%] mx-auto">
          <h2 className="text-center font-light text-primaryText ">
            You can pledge to do a <span className="font-bold">little</span> or
            a <span className="font-bold">lot</span>
          </h2>
          <p className="text-center font-light mt-6">
            We dont want to add unnecessary pressure on your business to take on
            a full scale clean energy transition plan. We've got energy for
            every need to help you transition based on how much you're ready to
            take on.
          </p>
        </div>
        ...
        <div className="flex  lg:flex overflow-y-hidden overflow-x-scroll scrollbar-hide gap-4 ">
          <div className="bg-white w-[300px] sm:w-[240px] md:w-[320px] lg:w-[350px] px-8 py-10 rounded-xl flex flex-col gap-2 items-center text-center space-y-6">
            ...
            <p>
              Assess your consumpion and identify inefficient energy use and
              areas to save.
            </p>
        ...
        <div className="sm:w-[80%] md:w-full lg:w-[80%] mx-auto ">
          ...
          <div className="flex md:justify-center md:flex-wrap lg:flex overflow-y-hidden overflow-x-scroll scrollbar-hide gap-4 ">
            <div className="bg-white min-w-[300px] sm:w-[270px] lg:w-[49%] p-6 rounded-xl flex flex-col gap-2">
              ...
              <p>
                You can get guidance from one of our accredited sustainability
                support managers.
              </p>
            </div>
            <div className="bg-white min-w-[300px] sm:w-[270px] lg:w-[49%] p-6 rounded-xl flex flex-col gap-2">
            ...
            <div className="bg-white min-w-[300px] sm:w-[270px] lg:w-[49%] p-6 rounded-xl flex flex-col gap-2">
              ...
              <p>
                Get rewarded as a result of the environmental and sustainability
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-8 lg:gap-32 sm:w-[80%] md:w-full lg:w-[90%] xl:w-[75%] mx-auto">
          <div className="text-center lg:text-left">
            <h2 className="text-primaryText font-bold">
            ...
            <p className="mt-6 mb-8">
              ...
              Origin assessment tool to transition to cleaner energy solutions,
              at a price point that suits them.
            </p>
          ...
          <div className="bg-white w-[327px] md:w-full rounded-2xl px-5 py-8 flex flex-col  gap-6 mx-auto">
            ...
            <p className="text-base">
              At no extra cost to me and without making any changes to my cafe,
              my carbon emissions were offset by Origin.
            </p>
            <div>
              <p>Betty</p>
