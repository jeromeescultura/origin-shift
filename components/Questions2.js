...
function Questions2({ qsts }) {
  ...
  return (
    <>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col gap-8 mt-2">
                      ...
                      <div className="form-check flex items-center gap-4">
                        ...
                        >
                          Replaced some or all energy inneficient equipment at
                          your site(s) with more efficient ones
                        </label>
                      </div>
                      <div className="form-check flex items-center gap-4">
                        <input
                        ...
                        <label
                          ...
                          htmlFor="flexCheckDefault"
                        >
                          Switch to an energy plan that carbon offsets your
                          energy use
                        </label>
                      </div>
                      <div className="form-check flex items-center gap-4">
                      ...
                      <div className="form-check flex items-center gap-4">
                        ...
                        <label
                          ...
                          htmlFor="flexCheckDefault"
                        >
                          Replaced some or all of your vehicle fleet with
                          electric vehicles
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-8 mt-2">
                      ...
                      <div className="form-check flex items-center gap-4">
                        ...
                        <label
                          ...
                          htmlFor="flexCheckDefault"
                        >
                          Replaced some or all packaging used for your business
                          to use more sustainable alternatives
                        </label>
                      </div>
                      <div className="form-check flex items-center gap-4">
                        <input
      ...
      {choices.electricity && <div>Step two #2</div>}
      {choices.little && <div>Step three #2</div>}
    </>
  );
}
